...
from avalanche.benchmarks.datasets.external_datasets.food101 import \
    get_food101_dataset
...
def SplitFood100(
    ...
    *,
    ...
    food_train, food_test = get_food101_dataset(dataset_root, input_size)
...
if __name__ == "__main__":
    ...
    benchmark_instance = SplitFood100(10, input_size=(32,32))
