...
class ActiveMemoryReplayPlugin(SupervisedPlugin):
    """
    ...
    def before_training_exp(
        ...
        **kwargs
        ...
        al_strategy = self.al_strategy(strategy.experience.dataset, strategy=strategy, fraction=self.fraction, mem=self.storage_policy.buffer)
