...
from avalanche.training.storage_policy import ClassBalancedBuffer, ReservoirSamplingBuffer
...
class ActiveReplay(SupervisedTemplate):
    """Experience replay strategy.
    ...
    def __init__(
        ...
        **base_kwargs
        ...
        self.arp = ActiveReplayPlugin(al_strategy, fraction=fraction, mem_size=mem_size)
        if plugins is None:
            plugins = [self.arp]
        else:
            plugins.insert(0,self.arp)
        super().__init__(
            model,
            optimizer,
            criterion,
...
class ActiveMemoryReplay(SupervisedTemplate):
    """Experience replay strategy.
    ...
    def __init__(
        ...
        **base_kwargs
        ...
        """
        self.fraction = fraction
        self.arp = ActiveMemoryReplayPlugin(al_strategy, fraction=fraction, mem_size=mem_size)
        if plugins is None:
            plugins = [self.arp]
        else:
            plugins.insert(0,self.arp)
...
class SynapticIntelligence(SupervisedTemplate):
    ...
    def __init__(
        ...
        **base_kwargs
        ...
        plugins.insert(0,SynapticIntelligencePlugin(si_lambda=si_lambda, eps=eps))
