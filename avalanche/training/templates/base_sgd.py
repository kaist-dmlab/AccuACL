...
class BaseSGDTemplate(
    ...
    **Evaluation loop**
    ...
    def _before_training_exp(self, er_ace=False, **kwargs):
    ...
    def make_train_dataloader(
        ...
        **kwargs
        ...
        for k, v in kwargs.items():
            if k == 'custom_selection_result' or k=='no_update' or k=='full_data':
                continue
    ...
    def make_eval_dataloader(
        self, num_workers=4, pin_memory=True, persistent_workers=False, **kwargs
    ):
        """
