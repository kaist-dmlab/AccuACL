...
from avalanche.experiments.utils import create_default_args, set_seed, restrict_dataset_size
...
def mir_smnist(override_args=None):
    ...
    interactive_logger = WandBLogger()
    ...
    plugins = [
        MIRPlugin(
            batch_size_mem=args.batch_size_mem, mem_size = args.mem_size, subsample=args.subsample,
        )
    ]
